        ...
        <section id="contentBlocks" class="custom-blocks">
          ...
          <article class="custom-block-item">
            <div class="block--item-size">
               <img src="http://dobledos.depura-creatividad.com/img/cms/a lamedida_superexpress.jpg" alt="" width="868" height="649" />
            ...
            <div class="block--item-size">
               <img src="http://dobledos.depura-creatividad.com/img/cms/a lamedida_estilos.png" alt="" width="868" height="649" />
